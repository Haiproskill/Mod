...
// Правила Форума
echo '<div class="mrt-code card shadow--2dp"><div class="phdr"><h4><a href="?"><b>' . _t('Information, FAQ') . '</b></a>&#160;|&#160;' . _t('Forum rules') . '</h4></div>' .
    '<div class="list1"><p>';
...
echo '</p></div></div><div class="mrt-code card shadow--2dp"><div class="phdr"><a href="' . $_SESSION['ref'] . '">' . _t('Back') . '</a></div></div>';
