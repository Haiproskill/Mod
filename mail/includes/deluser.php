...
if ($id) {
    ...
    if (isset($_POST['submit'])) {
        ...
        echo '<div class="gmenu text-center"><p>' . _t('Contact deleted') . '</p><p><a href="index.php">' . _t('Continue') . '</a></p></div>';
    } else {
        echo '<div class="mrt-code card shadow--2dp"><div class="phdr"><h4>' . _t('Delete') . '</h4></div>
        ...
        echo '<div class="list1"><a href="' . (isset($_SERVER['HTTP_REFERER']) ? htmlspecialchars($_SERVER['HTTP_REFERER']) : 'index.php') . '">' . _t('Back') . '</a></div></div>';
    }
} else {
