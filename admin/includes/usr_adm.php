...
$smd = 0;
$mod = 0;
echo '<div class="mrt-code card shadow--2dp"><div class="phdr"><h4><a href="index.php"><b>' . _t('Admin Panel') . '</b></a>&#160;|&#160;' . _t('Administration') . '</h4></div>';
...
echo '</div>';
echo '<div class="mrt-code card shadow--2dp"><div class="phdr">' . _t('Total') . ': ' . ($sw + $adm + $smd + $mod) . '</div>' .
    '</div>';
