...
--
-- Table structure for table `banking_ipay`
--
DROP TABLE IF EXISTS `banking_ipay`;
CREATE TABLE `banking_ipay` (
  `id`          INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id`     INT(10) UNSIGNED NOT NULL DEFAULT '0',
  `acc_id`      INT(10) UNSIGNED NOT NULL DEFAULT '0',
  `value`       INT(40) NOT NULL DEFAULT '0',
  `text`        TEXT NOT NULL,
  `number`      TEXT NOT NULL,
  `seri`        TEXT NOT NULL,
  `branch`      TEXT NOT NULL,
  `type_active` TINYINT(3) UNSIGNED NOT NULL DEFAULT '0',
  `type_form`   TINYINT(4) UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `cms_forum_files` (
  ...
  `balans`   INT(40) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cms_forum_files_buy`
--
DROP TABLE IF EXISTS `cms_forum_files_buy`;
CREATE TABLE `cms_forum_files_buy` (
  `id`      INT(10) UNSIGNED  NOT NULL AUTO_INCREMENT,
  `file_id` INT(10) UNSIGNED  NOT NULL DEFAULT '0',
  `user_id` INT(11) NOT NULL DEFAULT '0',
  `link`    TEXT NOT NULL,
...
--
-- Table structure for table `cms_users_guestbook_comments`
--
DROP TABLE IF EXISTS `cms_users_guestbook_comments`;
CREATE TABLE IF NOT EXISTS `cms_users_guestbook_comments` (
  `id`       INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `forum` (
  ...
  `time`            INT(10) UNSIGNED NOT NULL DEFAULT '0',
  `post-time`       INT(10) UNSIGNED NOT NULL DEFAULT '0',
  `check-time`      INT(10) UNSIGNED NOT NULL DEFAULT '0',
  `check-by`        INT(10) UNSIGNED NOT NULL DEFAULT '0',
  `user_id`         INT(10) UNSIGNED NOT NULL DEFAULT '0',
  `from`            VARCHAR(25)  NOT NULL DEFAULT '',
  `realid`          INT(3)  NOT NULL DEFAULT '0',
  `cited`           INT(10) UNSIGNED NOT NULL DEFAULT '0',
  `ip`              BIGINT(11) NOT NULL DEFAULT '0',
  `ip_via_proxy`    BIGINT(11) NOT NULL DEFAULT '0',
  `soft`            TEXT  NOT NULL,
  `text`            TEXT  NOT NULL,
  ...
  `chuong`          INT(10) NOT NULL DEFAULT '0',
  `bai`             INT(10) NOT NULL DEFAULT '0',
  `view`            INT(11) NOT NULL DEFAULT '0',
  `moderation`      CHAR(1) NOT NULL DEFAULT '0',
  `moderation_who`  INT(10) UNSIGNED NOT NULL DEFAULT '0',
  `thumb_extension` VARCHAR(4) NOT NULL DEFAULT 'none',
  PRIMARY KEY (`id`),
  KEY `refid` (`refid`),
  KEY `type` (`type`),
  KEY `time` (`time`),
...
CREATE TABLE `forum_reactions` (
  ...
  `time`      INT(10) UNSIGNED NOT NULL DEFAULT '0',
  `reactions` enum('Like','Love','Haha','Hihi','Woww','Cry','Angry','WTF') NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_msg_id_reaction_type` (`post_id`,`reactions`)
)
  ENGINE = MyISAM
  DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE `users` (
  `id` INT(10) UNSIGNED  NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(50)  NOT NULL DEFAULT '',
  `name_lat` VARCHAR(50)  NOT NULL DEFAULT '',
  ...
  `smileys_status` VARCHAR(100)  NOT NULL DEFAULT '',
  `ip` BIGINT(11) NOT NULL DEFAULT '0',
  `ip_via_proxy` BIGINT(11) NOT NULL DEFAULT '0',
  ...
  `balans` BIGINT NOT NULL DEFAULT '0',
  `balansUp` BIGINT NOT NULL DEFAULT '0',
  `balansDown` BIGINT NOT NULL DEFAULT '0',
  `balansAdd` BIGINT NOT NULL DEFAULT '0',
  `balansReturn` BIGINT NOT NULL DEFAULT '0',
